...
//made the day and date for the checkoutpage
const today=dayjs();
...
//take the product id from the cart array
...
//fixing the date in checkoutpage
  ...
  js-cart-item-container-${machingProduct.id}">
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="delivery-options">
            ...
            ${deliveryOptionsHTML(machingProduct,
              cartItem
            )}
...
function deliveryOptionsHTML(machingProduct,cartItem){
  ...
  deliveryOptions.forEach((deliveryOption)=>{
    ...
    const dateString=deliveryDate.format(
      'dddd,MMMM D');
      //delivery charge for the delivery option
      const priceString= deliveryOption.priceCents===0
      ?
      'FREE' : ` $${formatCurrency(deliveryOption.priceCents)} - `;
      const isChecked=deliveryOption.id===cartItem.deliveryOptionId;

      //add it in the string put it in the web page
      html+=
